...
list_of_prices = []
mileages = []
url = "https://joautok.hu/hasznaltauto/budapest/hasznalt/volkswagen/passat?page=1"

page_counter = 2
while len(list_of_prices) < 75:
...
# save to excel file
df.to_excel('ch2ex2/raw/dataset.xlsx', header=True, index=False)